...
class CoversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cover" do
    assert_difference('Cover.count') do
      post covers_url, params: { cover: { description: @cover.description, title: @cover.title } }
    end
  ...
  test "should update cover" do
    patch cover_url(@cover), params: { cover: { description: @cover.description, title: @cover.title } }
